...
//       dispatch(setUser({ user: user, token: userInfo.token }));

//       if ((user as TUser)?.isAdmin) {
//         toast.success("Logged In successful!", { id: tostId, duration: 2000 });
//       } else {
...
//     } catch (error: any) {
//       if (error.data) {
//         const { reason } = error.data as ErrorResponse;
//         toast.error(reason, { id: tostId });
//       }
//     }
//   };
